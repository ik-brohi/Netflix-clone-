...
export declare function loadWeightsFromJson(weightsJSON: PyJsonDict, layers: Layer[], skipMismatch?: boolean): void;
...
export declare abstract class Container extends Layer {
    ...
    loadWeights(weightsJSON: PyJsonDict | NamedTensorMap, skipMismatch?: boolean, isNamedTensorMap?: boolean, strict?: boolean): void;
